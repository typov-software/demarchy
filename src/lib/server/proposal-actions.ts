export async function createDraftProposal() {
   ...
   * Can be done by any group member or higher
   */
}
...
export async function openProposal() {
  /**
   * TODO
   * Open a draft proposal's access to the group members it was submitted to
   * Can be done by any group member or higher
   */
}
...
export async function requestAdoption() {
   ...
   * - Adoption threshold determined by group settings determined by members
...
export async function adoptProposal() {
  /**
   * TODO
   * Merges a proposals changes into the group library and activity record
